(component
  (core module (;0;)
    ...
    (func (;49;) (type 13) (param i64 i64 i32) (result i64 i32)
      (local i64)
      local.get 0
      local.get 1
      i64.add
    ...
    (func (;50;) (type 14) (param i64 i64) (result i64)
      local.get 0
      local.get 1
      i32.const 0
      call 49
    ...
    (func (;51;) (type 1)
      ...
      i32.const 0
      i32.const 1
      if (type 4) (param i32 f64 i32) (result i32 f64 i32) ;; label = @1
      end
      drop
      drop
      drop
